...
import com.weaver.netty.xml.HasXML;
import com.weaver.netty.xml.XMLBuilder;
...
public abstract class Stanza implements HasXML {
	 ...
	 */
	@Nullable
	public final String getExtension(final String name, final String namespace) {
        return xml.getFirstChild("query").getAttribute(namespace);
	}
