...
public class Message extends Stanza {
	...
	public XMLElement getChildElement(String name,String namespace){
		ImmutableList<XMLElement> children = this.getXML().getChildren(name);

		UnmodifiableIterator<XMLElement> iterator = children.iterator();
		...
		}while (element.getNamespace().equals(namespace));

		return element;
	}

	public Message createCopy(){
		return new Message(this.xml);
	}
